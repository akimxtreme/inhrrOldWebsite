...
?>
<p>&nbsp;</p>
<form name="form1" method="post" action="agtipo_personal.php">
...
<!--CAMPOS DINAMICOS-->
<div id="Objeto2">
	<div>&nbsp;Tipo de Personal</div><div>&nbsp;<input type="text" name="txtTipo" id="txtTipo" size="50" maxlength="50"/></div><br />
</div>
</td></tr>
<tr><td colspan="3" align="left">&nbsp;</td></tr>
