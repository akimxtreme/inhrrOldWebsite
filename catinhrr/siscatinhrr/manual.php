...
<td width="200" valign="top">
	...
	<tr><td width="220">
	<a href="manual.pdf" target="_top">MANUAL DEL SISTEMA</a> 
	</td></tr>
	<tr><td width="220">
...
<table width="500" border="0" align="left" cellpadding="0" cellspacing="0">
	<tr>
    <td colspan="3" class="Estilo8" align="left" height="50"><p>MANUAL EN CONSTRUCCION </p>
      <p><img src="../imagenes/en_construccion.jpg" width="315" height="315" border="0" /></p></td>    
  </tr>
  <!--
  ...
  <tr height="50">
   ...
   <tr height="50">
    <td width="160" height="30" div align="left" class="Estilo1">&nbsp;</td>
    <td width="400" height="30" colspan="2" class="Estilo1">&nbsp;</td>
  </tr>
    </form>
	</table>
</td>
...
<p>&nbsp;<br /></p>
<!--
	<IFRAME id=con name=contenido marginWidth=0 marginHeight=0 src="socios_registrados.php" frameBorder=0 width=750 scrolling=index height=550></IFRAME>
-->
