...
function Header()
{
	...
	$this->SetTextColor(0,0,0);
	$this->SetLineWidth(.1);
	$this->Cell(12,5,'CODIGO',1,0,'C',0);
	//COLUMNA 2
	$this->Cell(27,5,'NUMERAL / LITERAL',1,0,'C',0);
	//COLUMNA 3
	$this->Cell(110,5,'CONCEPTO - SUBCONCEPTO DEL PAGO',1,0,'C',0);
	//COLUMNA 4
	$this->Cell(30,5,'BASE IMPONIBLE',1,0,'C',0);
	//COLUMNA 5
	$this->Cell(20,5,'TARIFA',1,0,'C',0);
	//COLUMNA 6
	$this->Cell(30,5,'PAGOS MAYORES A',1,0,'C',0);
	//COLUMNA 7
	$this->Cell(70,5,'CONCEPTO INHRR',1,0,'C',0);
	//COLUMNA 8
	$this->Cell(20,5,'PORCENTAJE',1,1,'C',0);	
}
...
$pdf->SetLineWidth(.1);
$pdf->MultiCell(12,5,$codigo[$c],'T','C',0);
//FILA 4 CELDA 2
$pdf->setXY(32,$y);
$pdf->MultiCell(27,5,$numeral[$c].' / '.$literal[$c],'T','C',0);
//FILA 4 CELDA 3
$pdf->setXY(59,$y);
$pdf->MultiCell(110,5,$concepto_pago[$c].' - '.$subconcepto_pago[$c],'T','L',0);
//FILA 4 CELDA 2
$pdf->setXY(169,$y);
$pdf->MultiCell(30,5,$imponible[$c],'T','C',0);
//FILA 4 CELDA 3
$pdf->setXY(199,$y);
$pdf->MultiCell(20,5,$tarifa[$c],'T','C',0);
//FILA 4 CELDA 4
$pdf->setXY(219,$y);
$pdf->MultiCell(30,5,$mayores[$c],'T','C',0);
//FILA 4 CELDA 5
$pdf->setXY(249,$y);
$pdf->MultiCell(70,5,$concepto_inhrr[$c],'T','L',0);
//FILA 4 CELDA 6
$pdf->setXY(319,$y);
$pdf->Cell(20,5,$porcentaje[$c],'T',1,'C',0);
$longitud=0;
$longitud=strlen($concepto_pago[$c]);
$longitud=$longitud+strlen($subconcepto_pago[$c]);
if($longitud>145){
	$y=$y+5;
}
if($y>=180){
